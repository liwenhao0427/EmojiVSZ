...
const unitsArray: Omit<UnitData, 'id'>[] = [
    ...
    { "name": "仙人掌棒", "emoji": "🌵", "type": "MELEE", "attackPattern": "SWING", "price": 45, "damage": 10, "cd": 1.67, "range": 120, "maxHp": 150, "effect": { "projectile_on_hit": 3 }, "desc": "挥舞时发射尖刺" },
    ...
    { "name": "加农炮", "emoji": "💣", "type": "ENGINEERING", "attackPattern": "SHOOT", "projectileEmoji": "💥", "price": 250, "damage": 50, "cd": 2.5, "range": 1200, "maxHp": 100, "desc": "发射高伤害爆炸炮弹，射速较慢。" },
