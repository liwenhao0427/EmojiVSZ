...
const unitsArray: Omit<UnitData, 'id'>[] = [
    ...
    { "name": "树枝", "emoji": "🥢", "tier": 1, "type": "MELEE", "attackPattern": "SWING", "price": 90, "damage": 20, "cd": 1.0, "range": 1, "maxHp": 100, "effect": { "stick_bonus": 4 }, "desc": "场上树枝越多伤害越高" },
    ...
    { "name": "小刀", "emoji": "🔪", "tier": 1, "type": "MELEE", "attackPattern": "SWING", "price": 120, "damage": 14, "cd": 0.5, "range": 1, "maxHp": 120, "crit": 0.25, "desc": "快速挥砍，暴击率高" },
    // --- TIER 2 ---
    { "name": "火把", "emoji": "🕯️", "tier": 2, "type": "MELEE", "attackPattern": "SWING", "price": 160, "damage": 16, "cd": 1.0, "range": 1, "maxHp": 200, "effect": { "burn_chance": 100 }, "desc": "攻击100%使敌人燃烧" },
