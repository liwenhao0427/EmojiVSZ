...
*   **尺寸:** 一个 5 行 9 列的网格。
*   **放置:** 每个格子只能放置一个单位。
*   **交互:** 在商店阶段，可以通过拖拽单位来交换它们的位置或移动到空格。在战斗阶段，单位位置被锁定。右键点击单位可以将其出售。
...
| **火把** | 🕯️ | MELEE | 快速近战攻击，100%附加燃烧效果。 |
| **魔杖** | 🪄 | MAGIC | 发射**追踪**魔法弹，并附加燃烧效果。 |
| **喷火器** | 🔥 | MAGIC | 持续向前方喷射火焰流，对范围内的多个敌人造成伤害。 |
| **狙击机器人** | 🔭 | RANGED | 极远射程和极高伤害，但攻击速度极慢。 |

### 6.2 商店道具 (Brotato-style)

| 名称 | 等级 | 效果示例 |
| :--- | :--- | :--- |
| **友善的外星蛙**| 1 | +5% 伤害, 但敌人数量 +5%。 |
| **招财猫** | 1 | 商店价格 -5% (可叠加)。 |
| **摇钱树苗** | 2 | 在每波开始时，根据你当前的存款获得利息。 |
| **玻璃螳螂** | 3 | +25% 伤害, 但 -15 最大生命值。 |
| **平头哥警员**| 3 | 每结束一个波次，永久 +3% 伤害 (可无限叠加)。 |
| **弹弹史莱姆** | 4 | 弹射物可多反弹1次，但伤害 -35%。 |
